...
import grow.plus.app.BasesDeDadosDasPerguntas.QuizBdHelperQuizEstatuas;
...
public class QuizEstatuas extends AppCompatActivity {


    public static final String EXTRA_SCORE_ESTATUAS = "extraScoreEstatuas";
    ...
    private ImageView imagemDaEstatua;

    private ColorStateList textColorDefault;


    private List<PerguntasQuizComImagem> perguntaList;

    private int perguntaCounter;
    private int perguntaCountTotal;

    private PerguntasQuizComImagem currentPergunta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_estatuas);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);

        textViewNrPergunta = findViewById(R.id.textViewPerguntaNrEstatuas);
        textViewScore = findViewById(R.id.textViewScoreEstatuas);
        textViewPergunta = findViewById(R.id.textViewPerguntaEstatuas);
        textViewTempo = findViewById(R.id.textViewTempoEstatuas);
        opcao1 = findViewById(R.id.buttonOpcao1Estatuas);
        opcao2 = findViewById(R.id.buttonOpcao2Estatuas);
        opcao3 = findViewById(R.id.buttonOpcao3Estatuas);
        opcao4 = findViewById(R.id.buttonOpcao4Estatuas);
        confirmar = findViewById(R.id.buttonConfirmarEstatuas);
        rbGroup = findViewById(R.id.radioGroupEstatuas);
        imagemDaEstatua = findViewById(R.id.imageViewEstatua);

        textColorDefault=opcao1.getTextColors();
        textColorDefaultCd=textViewTempo.getTextColors();

        QuizBdHelperQuizEstatuas bdHelper = new QuizBdHelperQuizEstatuas(this);
            ...
            public void onClick(View view) {
                if(!respostas){
                    if(opcao1.isClickable() ||  opcao2.isClickable() || opcao3.isClickable() || opcao4.isClickable()){
                        ...
                        Toast.makeText(QuizEstatuas.this, R.string.por_davor_selecionar_uma_opcao, Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showProximaPergunta();
                }
    ...
    private void showProximaPergunta(){
        ...
        if(perguntaCounter < perguntaCountTotal){
            ...
            imagemDaEstatua.setImageResource(currentPergunta.getImage());
    ...
    private void finishQuiz(){
        ...
        resultIntent.putExtra(EXTRA_SCORE_ESTATUAS, score);
