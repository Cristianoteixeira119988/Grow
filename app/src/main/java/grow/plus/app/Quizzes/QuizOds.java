...
import grow.plus.app.BasesDeDadosDasPerguntas.QuizBdHelperQuizOds;
...
public class QuizOds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewNrPergunta = findViewById(R.id.textViewPerguntaNr);
        textViewScore = findViewById(R.id.textViewScore);
        textViewPergunta = findViewById(R.id.textViewPergunta);
        textViewTempo = findViewById(R.id.textViewTempo);
        opcao1 = findViewById(R.id.buttonOpcao1);
        opcao2 = findViewById(R.id.buttonOpcao2);
        opcao3 = findViewById(R.id.buttonOpcao3);
        opcao4 = findViewById(R.id.buttonOpcao4);
        ...
        QuizBdHelperQuizOds bdHelper = new QuizBdHelperQuizOds(this);
            ...
            public void onClick(View view) {
                if(!respostas){
                    if(opcao1.isClickable() ||  opcao2.isClickable() || opcao3.isClickable() || opcao4.isClickable()){
                        ...
                        Toast.makeText(QuizOds.this, R.string.por_davor_selecionar_uma_opcao, Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showProximaPergunta();
                }
