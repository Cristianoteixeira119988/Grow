...
import grow.plus.app.BasesDeDadosDasPerguntas.QuizBdHelperQuizBoaSaudeEBemEstar;
...
public class QuizBoaSaudeEBemEstar extends AppCompatActivity {

    public static final String EXTRA_SCORE_SAUDE_DE_QUALIDADE = "extraScoreSaudeDeQualidade";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_boa_saude_e_bem_estar);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);


        textViewNrPergunta = findViewById(R.id.textViewPerguntaNrSaudeDeQualidade);
        textViewScore = findViewById(R.id.textViewScoreSaudeDeQualidade);
        textViewPergunta = findViewById(R.id.textViewPerguntaSaudeDeQualidade);
        textViewTempo = findViewById(R.id.textViewTempoSaudeDeQualidade);
        opcao1 = findViewById(R.id.buttonOpcao1SaudeDeQualidade);
        opcao2 = findViewById(R.id.buttonOpcao2SaudeDeQualidade);
        opcao3 = findViewById(R.id.buttonOpcao3SaudeDeQualidade);
        opcao4 = findViewById(R.id.buttonOpcao4SaudeDeQualidade);
        confirmar = findViewById(R.id.buttonConfirmarSaudeDeQualidade);
        rbGroup = findViewById(R.id.radioGroupSaudeDeQualidade);

        textColorDefault=opcao1.getTextColors();
        textColorDefaultCd=textViewTempo.getTextColors();

        QuizBdHelperQuizBoaSaudeEBemEstar bdHelper = new QuizBdHelperQuizBoaSaudeEBemEstar(this);
            ...
            public void onClick(View view) {
                if(!respostas){
                    if(opcao1.isClickable() ||  opcao2.isClickable() || opcao3.isClickable() || opcao4.isClickable()){
                        ...
                        Toast.makeText(QuizBoaSaudeEBemEstar.this, R.string.por_davor_selecionar_uma_opcao, Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showProximaPergunta();
                }
    ...
    private void finishQuiz(){
        ...
        resultIntent.putExtra(EXTRA_SCORE_SAUDE_DE_QUALIDADE, score);
