...
import grow.plus.app.BasesDeDadosDasPerguntas.QuizBdHelperQuizEnergiasRenovaveisEAcessiveis;
import grow.plus.app.Perguntas.PerguntaQuiz;
import grow.plus.app.R;

public class QuizEnergiasRenovaveis extends AppCompatActivity {

    public static final String EXTRA_SCORE_ENERGIAS_RENOVAVEIS = "extraScoreEnergiasRenovaveis";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_energias_renovaveis);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);

        textViewNrPergunta = findViewById(R.id.textViewPerguntaNrEnergiasRenovaveis);
        textViewScore = findViewById(R.id.textViewScoreEnergiasRenovaveis);
        textViewPergunta = findViewById(R.id.textViewPerguntaEnergiasRenovaveis);
        textViewTempo = findViewById(R.id.textViewTempoEnergiasRenovaveis);
        opcao1 = findViewById(R.id.radioButtonOpcao1EnergiasRenovaveis);
        opcao2 = findViewById(R.id.radioButtonOpcao2EnergiasRenovaveis);
        opcao3 = findViewById(R.id.radioButtonOpcao3EnergiasRenovaveis);
        opcao4 = findViewById(R.id.radioButtonOpcao4EnergiasRenovaveis);
        confirmar = findViewById(R.id.buttonConfirmarEnergiasRenovaveis);
        rbGroup = findViewById(R.id.radioGroupEnergiasRenovaveis);

        textColorDefault=opcao1.getTextColors();
        textColorDefaultCd=textViewTempo.getTextColors();

        QuizBdHelperQuizEnergiasRenovaveisEAcessiveis bdHelper = new QuizBdHelperQuizEnergiasRenovaveisEAcessiveis(this);
            ...
            public void onClick(View view) {
                if(!respostas){
                    if(opcao1.isClickable() ||  opcao2.isClickable() || opcao3.isClickable() || opcao4.isClickable()){
                        ...
                        Toast.makeText(QuizEnergiasRenovaveis.this, R.string.por_davor_selecionar_uma_opcao, Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showProximaPergunta();
                }
    ...
    private void finishQuiz(){
        ...
        resultIntent.putExtra(EXTRA_SCORE_ENERGIAS_RENOVAVEIS, score);
