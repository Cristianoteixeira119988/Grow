...
import grow.plus.app.BasesDeDadosDasPerguntas.QuizBdHelperQuizHistoriaDoMundo;
...
public class QuizHistoriaDoMundo extends AppCompatActivity {

    public static final String EXTRA_SCORE_HISTORIA_DO_MUNDO = "extraScoreHistoriaDoMundo";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_historia_do_mundo);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);


        textViewNrPergunta = findViewById(R.id.textViewPerguntaNrHistoriaDoMundo);
        textViewScore = findViewById(R.id.textViewScoreHistoriaDoMundo);
        textViewPergunta = findViewById(R.id.textViewPerguntaHistoriaDoMundo);
        textViewTempo = findViewById(R.id.textViewTempoHistoriaDoMundo);
        opcao1 = findViewById(R.id.buttonOpcao1HistoriaDoMundo);
        opcao2 = findViewById(R.id.buttonOpcao2HistoriaDoMundo);
        opcao3 = findViewById(R.id.buttonOpcao3HistoriaDoMundo);
        opcao4 = findViewById(R.id.buttonOpcao4HistoriaDoMundo);
        confirmar = findViewById(R.id.buttonConfirmarHistoriaDoMundo);
        rbGroup = findViewById(R.id.radioGroupHistoriaDoMundo);

        textColorDefault=opcao1.getTextColors();
        textColorDefaultCd=textViewTempo.getTextColors();

        QuizBdHelperQuizHistoriaDoMundo bdHelper = new QuizBdHelperQuizHistoriaDoMundo(this);
            ...
            public void onClick(View view) {
                if(!respostas){
                    if(opcao1.isClickable() ||  opcao2.isClickable() || opcao3.isClickable() || opcao4.isClickable()){
                        ...
                        Toast.makeText(QuizHistoriaDoMundo.this, R.string.por_davor_selecionar_uma_opcao, Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showProximaPergunta();
                }
    ...
    private void finishQuiz(){
        ...
        resultIntent.putExtra(EXTRA_SCORE_HISTORIA_DO_MUNDO, score);
