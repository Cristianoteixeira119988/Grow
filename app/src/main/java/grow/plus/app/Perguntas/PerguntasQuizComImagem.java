...
public class PerguntasQuizComImagem {
    ...
    public PerguntasQuizComImagem() {

    }
    public PerguntasQuizComImagem(int image, String pergunta, String opcao1, String opcao2, String opcao3, String opcao4, int respostaNr) {
        this.image = image;
